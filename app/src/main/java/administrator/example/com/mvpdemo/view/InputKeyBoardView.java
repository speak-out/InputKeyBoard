package administrator.example.com.mvpdemo.view;
...
import administrator.example.com.mvpdemo.R;
...
public class InputKeyBoardView extends RelativeLayout{
    ...
    @OnClick({R.id.txt_1, R.id.txt_2, R.id.txt_3, R.id.txt_4, R.id.txt_5, R.id.txt_6, R.id.txt_7, R.id.txt_8, R.id.txt_9, R.id.txt_0, R.id.txt_delete, R.id.txt_confirm})
